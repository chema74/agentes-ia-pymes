...
def generate_synthetic_transactions(n_transactions: int = 1000, fraud_rate: float = 0.02) -> pd.DataFrame:
    """
    ...
    users = [
        {
            ...
            'preferred_categories': random.sample(['supermarket', 'restaurant', 'gas_station', 'online_shopping', 'utilities'], k=2),
            'location': fake.city()
        }
...
if __name__ == "__main__":
    ...
    print(f"💾 Guardado en: data/synthetic/transactions_demo.csv")