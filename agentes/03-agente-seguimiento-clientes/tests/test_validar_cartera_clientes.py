...
class ValidarCarteraClientesTests(unittest.TestCase):
    def test_ejecucion_sin_argumentos(self):
        resultado = ejecutar_script()

        self.assertEqual(resultado.returncode, 0, resultado.stderr)
        self.assertIn("Informe de seguimiento de cartera", resultado.stdout)
    ...
    def test_ejecucion_con_ruta_explicita(self):
        ...
        self.assertIn("Numero total de clientes o registros", resultado.stdout)
