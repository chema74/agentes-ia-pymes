...
SCRIPT = (
    RAIZ_REPOSITORIO / "agentes" / "05-agente-operaciones-pymes" / "src" / "validar_operaciones.py"
)
JSON_FICTICIO = (
    RAIZ_REPOSITORIO
    / "agentes"
...
class ValidarOperacionesTests(unittest.TestCase):
    def test_ejecucion_sin_argumentos(self):
        resultado = ejecutar_script()

        self.assertEqual(resultado.returncode, 0, resultado.stderr)
        self.assertIn("Informe de validacion de operaciones", resultado.stdout)
    ...
    def test_ejecucion_con_ruta_explicita(self):
        ...
        self.assertIn("Numero total de operaciones", resultado.stdout)
