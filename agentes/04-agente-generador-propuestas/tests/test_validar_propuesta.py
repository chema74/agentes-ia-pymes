...
class ValidarPropuestaTests(unittest.TestCase):
    def test_ejecucion_sin_argumentos(self):
        resultado = ejecutar_script()

        self.assertEqual(resultado.returncode, 0, resultado.stderr)
        self.assertIn("Informe de validacion de propuesta", resultado.stdout)
    ...
    def test_ejecucion_con_ruta_explicita(self):
        ...
        self.assertIn("Estado general de la propuesta", resultado.stdout)
